...
def task_3():
    try:
        ...
        if color1 not in lambda_values:
        ...
        if color2 not in lambda_values:
            raise ValueError("Niepoprawny kolor. Wybierz z listy: fioletowy, niebieski, zielony, żółty, czerwony.")
        if color1 == color2:
            print(
                f"Wybrałeś dwa razy ten sam kolor: {color1}. Intensywność rozpraszania przez azot będzie taka sama.")
            return
